<p align="center">
  <a href="https://verify.wickra.org"><img src="https://raw.githubusercontent.com/wickra-lib/.github/main/profile/wickra-banner.webp?v=514" alt="Wickra Verify — confirm or refute a claimed backtest report against its strategy and data, in ten languages" width="100%"></a>
</p>
...
Source for the Wickra Verify site (**[verify.wickra.org](https://verify.wickra.org)**): hero, per-language API overviews and benchmarks.
...
**Wickra Verify** — confirm or refute a claimed backtest report against its strategy and data, in ten languages. The library itself is
[`wickra-lib/wickra-verify`](https://github.com/wickra-lib/wickra-verify); its README carries the install line and a quick start for every language.
...
- **The released version** — the version menu in the nav, the Maven snippet on the landing page and the Java API page — is pulled hourly from [wickra-verify's latest release](https://github.com/wickra-lib/wickra-verify/releases/latest) by `sync-from-verify.yml`.
...
Custom domain `verify.wickra.org` is configured in the Cloudflare Pages dashboard.
