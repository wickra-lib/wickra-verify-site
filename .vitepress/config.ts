  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'GitHub', link: 'https://github.com/wickra-lib/wickra-verify' },
      {
        text: 'Links',
        items: [
          { text: 'crates.io', link: 'https://crates.io/crates/wickra-verify-core' },
          { text: 'PyPI', link: 'https://pypi.org/project/wickra-verify/' },
          { text: 'npm', link: 'https://www.npmjs.com/package/wickra-verify' },
          { text: 'NuGet', link: 'https://www.nuget.org/packages/Wickra.Verify' },
          { text: 'Maven Central', link: 'https://central.sonatype.com/artifact/org.wickra/wickra-verify' },
          { text: 'Go module', link: 'https://pkg.go.dev/github.com/wickra-lib/wickra-verify-go' },
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'docs.rs', link: 'https://docs.rs/wickra-verify-core/latest/wickra_verify_core/' },
        ],
      },
      {
        text: 'Ecosystem',
